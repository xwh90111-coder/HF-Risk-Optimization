...
def draw_rich_stacking_topology():
    ...
    models = [
        ...
        {"name": "基模型 B: RF", "params": "n_estimators=200\nmax_depth=15", "y": 6.25},
    ...
    ax.text(6, 1.2, "Logistic Regression\n(Penalty='l2', C=1.0)", ha='center', fontsize=10)
    ...
    plt.savefig('figures/stacking_topology_rich.png', dpi=300, bbox_inches='tight')
    plt.close()
    print("[成功] 丰富版拓扑图已生成至 figures/stacking_topology_rich.png")
